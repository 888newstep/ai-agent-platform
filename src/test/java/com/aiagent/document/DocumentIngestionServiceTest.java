...
class DocumentIngestionServiceTest {
    ...
    void shouldProcessContentAndPersistChunks() {
        ...
        ArgumentCaptor<List<com.aiagent.entity.DocumentChunk>> captor = ArgumentCaptor.forClass(List.class);
        verify(documentChunkRepository).saveAll(captor.capture());
        List<com.aiagent.entity.DocumentChunk> saved = captor.getValue();
